...
[<img src="https://www.gatsbyjs.com/deploynow.svg" alt="Deploy to Gatsby Cloud">](https://www.gatsbyjs.com/dashboard/deploynow?url=https://github.com/alexkainzinger/gatsby-starter-tailwind-typescript-cdk)
...
5.  **`.prettierignore`**: This file tells [Prettier](https://prettier.io/) to ignore (i.e. not reformat) certain files and folders completely.
...
10. **`gatsby-ssr.js`**: This file is where Gatsby expects to find any usage of the [Gatsby server-side rendering APIs](https://www.gatsbyjs.com/docs/reference/config-files/gatsby-ssr/) (if any). These allow customization of default Gatsby settings affecting server-side rendering.
...
14. **`tailwind.config.js`**: A [Tailwind](https://tailwindcss.com/) config file for your project.

15. **`tsconfig.json`**: The presence of a `tsconfig.json` file indicates that the directory is the root of a [TypeScript](https://www.typescriptlang.org/) project. The file specifies the root files and the compiler options required to compile the project.
